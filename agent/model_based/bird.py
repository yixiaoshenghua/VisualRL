...
class Bird:
    '''
    PyTorch reimplementation of Neurlps 2020 Paper "Bridging Imagination and Reality for Model-Based Deep Reinforcement Learning"
    '''
    ...
    def actor_loss(self):
        ...
        with FreezeParameters(self.world_model_modules):
            imag_feats, imag_actions, imag_rews, imag_probs = self.imagine(posterior, self.args.imagine_horizon)
