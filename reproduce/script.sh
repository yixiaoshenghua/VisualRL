...
# Reproduce DreamerV1
python run.py --agent Dreamerv1 --env walker-walk --agent_type model_based --exp_name reproduce  --pre_transform_image_size 64 --image_size 64 --action_repeat 2 --frame_stack 1 --discrete 0 --update_steps 100 --batch_size 50 --init_steps 5000 --save_tb --gpu 0 --seed 1
# Reproduce DreamerV2
python run.py --agent Dreamerv2 --env walker-walk --agent_type model_based --exp_name reproduce  --pre_transform_image_size 64 --image_size 64 --action_repeat 2 --frame_stack 1 --update_steps 100 --batch_size 50 --init_steps 5000 --save_tb --gpu 0 --seed 1
# Reproduce SAC-AE
